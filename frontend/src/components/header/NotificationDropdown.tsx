...
const notifications = [
  {
    ...
    detail: "La table 4 a commandé 3 produits",
    time: "il y a 5 min",
    tone: "success" as const,
  },
  {
    id: 2,
    title: "Produit presque en rupture",
    detail: "Le Couscous Royal est presque en rupture de stock",
    time: "il y a 22 min",
  ...
  },
  {
    ...
    detail: "Un admin a ajouté la catégorie « Desserts »",
    time: "il y a 1 h",
    tone: "success" as const,
  },
];
        ...
        <ul className="flex flex-col overflow-y-auto custom-scrollbar">
          {notifications.map((item) => (
            <li key={item.id}>
              ...
              >
                <span
                  className={`mt-2 flex h-2.5 w-2.5 shrink-0 rounded-full ${
                    toneStyles[item.tone] || toneStyles.success
                  }`}
                ></span>
                <span className="block">
                  ...
                  <span className="mt-1.5 flex items-center gap-2 text-theme-xs text-gray-400 dark:text-gray-500">
                    {item.time}
                  </span>
                </span>
              </button>
