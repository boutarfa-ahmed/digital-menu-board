...
// WIP: page not finished yet — flip to true to bring it back.
...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 overflow-hidden rounded-full h-11 w-11 bg-brand-100 text-sm font-semibold text-brand-700 dark:bg-brand-500/15 dark:text-brand-400">
          {initials}
        </span>
      ...
      >
        <div
          className={
            PROFILE_ENABLED
              ? undefined
              : "pb-3 border-b border-gray-200 dark:border-gray-800"
          }
        >
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            {user.email || "admin@galaxyfood.com"}
          </span>
        </div>
