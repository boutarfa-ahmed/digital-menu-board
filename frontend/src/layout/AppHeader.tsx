...
// WIP: notifications not finished yet — flip to true to bring it back.
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/dashboard" className="lg:hidden">
            <span className="inline-flex items-center gap-2 text-gray-900 dark:text-white">
              <img src="/favicon.svg" alt="GalaxyFood" className="h-7 w-7" />
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            <ThemeToggleButton />
            {NOTIFICATIONS_ENABLED && <NotificationDropdown />}
          </div>
          <UserDropdown />
        </div>
      </div>
